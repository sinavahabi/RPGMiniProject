...
This program is a primary text-base Role Playing Battle Game.
Program in written with classes, so it's fully Object Oriented Programming.
...
Each time that battle is over, afew simple details such as player level, exp, game date and etc will be saved via json.
